...
public class OnDemandSHB extends AbstractSHB{

    private Integer[][] happensBeforeMat;
    ...
    public OnDemandSHB(C3GManager c3GManager){
        super(c3GManager);
        if(svcMap.size() > 3000)
            tooBig = true;
        if(!tooBig) {
            happensBeforeMat = new Integer[svcMap.size()][svcMap.size()];
